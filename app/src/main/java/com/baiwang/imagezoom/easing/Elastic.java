package com.baiwang.imagezoom.easing;
...
public class Elastic implements Easing {
	...
	private double easeIn(double t, double b, double c, double d, double a, double p) {
		double s;
		if ( t == 0 ) return b;
		if ( ( t /= d ) == 1 ) return b + c;
		if ( !( p > 0 ) ) p = d * .3;
	...
	private double easeOut(double t, double b, double c, double d, double a, double p) {
		double s;
		if ( t == 0 ) return b;
		if ( ( t /= d ) == 1 ) return b + c;
		if ( !( p > 0 ) ) p = d * .3;
	...
	private double easeInOut(double t, double b, double c, double d, double a, double p) {
		double s;
